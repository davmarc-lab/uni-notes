...
Dato un problema di classificazione binario e un \red{multi-classificatore} costituito da $nc$ classificatori ($nc$ dispari), la \hyperref[th:maj-vote-rule]{majority vote rule} classifica il pattern come appartenente alla classe cha ha ottenuto almeno $k = \pt{nc + 1} / 2$ voti.
\\
...
\begin{itemize}
    ...
    \item $\al[t]$ il peso del classificatore $h^t\pt x$ nell'a,bito del multi-classificatore;
\end{itemize}
