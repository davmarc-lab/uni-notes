...
\begin{itemize}
    \item \textbf{\ac{saas}}: consiste nell'utilizzo di programmi installati su un server remoto.
        Questo acronimo condivide in parte la filosofiadi un termine oggi in disuso: \acf{asp};
...
Il cloud offre ilmassimo livello di efficienza nella condivisione delle risorse sebbene sia maggiormente vulnerabile agli attacchi.
...
\begin{note}[Vantaggi Economici]
    \begin{itemize}
        ...
        \item capacità di ottimizzare i costi sia in termini di risprse computazionali, sia in termini di risorse umane di gestione;
