...
%
\subsection{Esempio di contratto}\label{sub:cv_esempio_di_contratto} % (fold)
    \href{../standalone/contratto-manutenzione/build/contr-man-si.pdf}{Contratto per la Manutezione Evolutiva nelle Pubbliche Amministrazioni}
% subsection Esempio di contratto (end)
